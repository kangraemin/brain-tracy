...
abstract class $GoalEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, DateTime createdAt, bool isSelected});
}
...
class _$GoalEntityImpl implements _GoalEntity {
  ...
  @override
  String toString() {
    return 'GoalEntity(id: $id, title: $title, createdAt: $createdAt, isSelected: $isSelected)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, createdAt, isSelected);
